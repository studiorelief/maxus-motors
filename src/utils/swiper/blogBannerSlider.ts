...
const HOME_BLOG_BANNER_SLIDER_CONFIG: SwiperOptions = {
  ...
  pagination: {
    el: '.blog-banner_component .swiper-pagination-wrapper',
 ...
 * @returns {void}
 */
export function initBlogBannerSlider(): void {
  const swipers = document.querySelectorAll('.swiper.is-blog-banner');
  ...
  swipers.forEach((swiperEl) => {
    try {
      new Swiper(swiperEl as HTMLElement, HOME_BLOG_BANNER_SLIDER_CONFIG);
    } catch (error) {
