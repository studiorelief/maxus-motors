...
const MOBILE_SLIDER_CONFIG: SwiperOptions = {
  ...
  pagination: {
    el: '.home_gamme_pagination .swiper-pagination-wrapper',
 ...
 * @returns {void}
 */
export function initMobileSlider(): void {
  const swipers = document.querySelectorAll('.swiper.is-mobile');
  ...
  swipers.forEach((swiperEl) => {
    try {
      new Swiper(swiperEl as HTMLElement, MOBILE_SLIDER_CONFIG);
    } catch (error) {
