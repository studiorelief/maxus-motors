...
const OFFRES_SLIDER_CONFIG: SwiperOptions = {
 ...
 * @returns {void}
 */
export function initOffresSlider(): void {
  const swipers = document.querySelectorAll('.swiper.is-offres');
  ...
  swipers.forEach((swiperEl) => {
    try {
      new Swiper(swiperEl as HTMLElement, OFFRES_SLIDER_CONFIG);
    } catch (error) {
